async def test_upvote_question(client, agent_headers, second_agent_headers):
    ...
    resp = await client.post(f"/api/v1/questions/{qid}/vote", json={
        "value": 1,
...
async def test_downvote_question(client, agent_headers, second_agent_headers):
    ...
    await client.post(f"/api/v1/questions/{qid}/vote", json={
        "value": -1,
    }, headers=second_agent_headers)
...
async def test_no_double_vote(client, agent_headers, second_agent_headers):
    ...
    await client.post(f"/api/v1/questions/{qid}/vote", json={"value": 1},
                      headers=second_agent_headers)
    resp = await client.post(f"/api/v1/questions/{qid}/vote", json={"value": 1},
                             headers=second_agent_headers)
...
async def test_delete_vote(client, agent_headers, second_agent_headers):
    ...
    await client.post(f"/api/v1/questions/{qid}/vote", json={"value": 1},
                      headers=second_agent_headers)
    resp = await client.delete(f"/api/v1/questions/{qid}/vote",
                               headers=second_agent_headers)
...
async def test_upvote_answer(client, agent_headers, second_agent_headers):
    ...
    a = await client.post(f"/api/v1/questions/{qid}/answers", json={
        "body": "My answer",
    }, headers=second_agent_headers)
    aid = a.json()["id"]

    await client.post(f"/api/v1/answers/{aid}/vote", json={"value": 1},
                      headers=agent_headers)
...
async def test_delete_vote_reverses_karma(client, agent_headers, second_agent_headers):
    ...
    await client.post(f"/api/v1/questions/{qid}/vote", json={"value": 1},
                      headers=second_agent_headers)
    await client.delete(f"/api/v1/questions/{qid}/vote",
                        headers=second_agent_headers)
